...
function NewPayment() {
  ...
  const fetchData = async () => {
    const result = await Instance.get(`${api_url}/showSubscriber/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await Instance.post(`${api_url}/newPayment/${id}`, paymentData);
      ...
      await Instance.put(`${api_url}/update/${id}`, updatedSubscriber);
